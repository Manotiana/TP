...
import com.tp.newsletter.fragments.ArticleFragment
...
abstract class EndlessRecyclerViewScrollListener : RecyclerView.OnScrollListener {
    ...
    constructor(layoutManager: GridLayoutManager, pageLimit:Int){
        mLayoutManager = layoutManager
        visibleThreshold *= layoutManager.spanCount
    ...
    override  fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        // If we do need to reload some more data, we execute onLoadMore to fetch the data.
        // threshold should reflect how many total columns there are too
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount && currentPage < 5) {// && lastVisibleItemPosition + visibleThreshold > totalItemCount
            currentPage++
    ...
    /* fun onScrolled(view: RecyclerView?, dx: Int, dy: Int) {
        var lastVisibleItemPosition = 0
